...
(function () {
    angular.module('sbAdminApp')
        .controller('ArticleCtrl', ['$scope', '$filter', 'articleService', '$state', '$stateParams', '$uibModal',
            function ($scope, $filter, ebookService, $state, $stateParams, $uibModal) {
                /**************************初始設定**************************/
                var id;
                var vm = this;
                vm.displayed = [];  //資料列
                ...
                vm.removeRow = function removeRow(contentID) {
                    if (confirm("確定要刪除?")) {
                        ebookService.deleteData(contentID);
                    }
                ...
                vm.callServer = function callServer(tableState) {
                    ...
                    ebookService.getList(start, number, tableState).then(function (result) {
