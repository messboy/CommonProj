...
(function () {
    angular.module('sbAdminApp')
        .factory('scienceService', ['$q', '$filter', '$timeout', '$http', '$state', 'paginationHelper', 'errorHelper',
        function ($q, $filter, $timeout, $http, $state, paginationHelper, errorHelper) {
            /**************************初始設定**************************/
            var getListApiURL = 'Science/GetList';
            var getDetailApiURL = 'Science/GetDetail';
            var addDataApiURL = 'Science/Add';
            var deleteDataApiURL = 'Science/Delete';
            var updateDataApiURL = 'Science/Update';
            ...
            function addData(vm) {
                ...
                then(function (response) {  //sucess
                    $state.go("dashboard.science", { obj: { message: "新增成功" } });
            ...
            function deleteData(id) {
                ...
                .then(function (response) {
                    $state.go("dashboard.science", {}, { reload: true });
                }, function (errorResponse) {    //fail
            ...
            function updateData(vm) {
                ...
                .then(function (response) {  //sucess
                    ...
                    $state.go("dashboard.science", { obj: { message: "更新成功" } });
                }, function (errorResponse) {    //fail
